                ...
                <MDBCol md={8} className="text-center">
                    ...
                    <div className="text-center md-4">
                        ...
                        <MDBCollapse show={showBelivered}>
                            <p>In most cases your whole order will be delivered at the same time. The following
                                exceptions
                                apply:</p>
                            <h3 className="red-text">LargeItems</h3>
                            <p>Delayed items will be despatched as soon as stock becomes available. You can track the
                                progress
                                of
                    ...
                    <div className="text-center md-4">
                        ...
                        <MDBCollapse show={showReceve}>
                            <p>When your item becomes available for despatch, we will email you so you can track your
                                order</p>
                        </MDBCollapse>
                    </div>
                    <br/>
